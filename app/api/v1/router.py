...
from app.api.v1.routers.dash import router as dash_router
from app.api.v1.routers.deployments import router as deployments_router
...
api_router.include_router(dash_router)
